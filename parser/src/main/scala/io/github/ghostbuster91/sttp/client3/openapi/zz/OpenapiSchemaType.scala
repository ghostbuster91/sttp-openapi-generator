...
object OpenapiSchemaType {
  ...
  implicit val OpenapiSchemaRefDecoder: Decoder[OpenapiSchemaRef] = {
    (c: HCursor) =>
      for {
        r <- c.downField("$ref").as[String]
      } yield OpenapiSchemaRef(r)
  }

  implicit val OpenapiSchemaBooleanDecoder
      : Decoder[OpenapiSchemaBoolean] = { (c: HCursor) =>
    for {
      _ <- c
        .downField("type")
        .as[String]
        .ensure(DecodingFailure("Given type is not boolean!", c.history))(
          _ == "boolean"
        )
  ...
  implicit val OpenapiSchemaStringTypeDecoder
      : Decoder[OpenapiSchemaStringType] = { (c: HCursor) =>
    for {
      _ <- c
        .downField("type")
        .as[String]
        .ensure(DecodingFailure("Given type is not string!", c.history))(
          _ == "string"
        )
      f <- c.downField("format").as[Option[String]]
      nb <- c.downField("nullable").as[Option[Boolean]]
    } yield f.fold[OpenapiSchemaStringType](
  ...
  implicit val OpenapiSchemaNumericTypeDecoder
      : Decoder[OpenapiSchemaNumericType] = { (c: HCursor) =>
    for {
      t <- c
        .downField("type")
        .as[String]
        .ensure(
          DecodingFailure("Given type is not number/integer!", c.history)
        )(v => v == "number" || v == "integer")
      f <- c.downField("format").as[Option[String]]
      nb <- c.downField("nullable").as[Option[Boolean]]
    } yield
      if (t == "number") {
  ...
  implicit val OpenapiSchemaSimpleTypeDecoder
      : Decoder[OpenapiSchemaSimpleType] =
  ...
  implicit val OpenapiSchemaOneOfDecoder: Decoder[OpenapiSchemaOneOf] = {
    (c: HCursor) =>
      for {
        d <- c.downField("oneOf").as[Seq[OpenapiSchemaSimpleType]]
      } yield OpenapiSchemaOneOf(d)
  }

  implicit val OpenapiSchemaAllOfDecoder: Decoder[OpenapiSchemaAllOf] = {
    (c: HCursor) =>
      for {
        d <- c.downField("allOf").as[Seq[OpenapiSchemaSimpleType]]
      } yield OpenapiSchemaAllOf(d)
  }

  implicit val OpenapiSchemaAnyOfDecoder: Decoder[OpenapiSchemaAnyOf] = {
    (c: HCursor) =>
      for {
        d <- c.downField("anyOf").as[Seq[OpenapiSchemaSimpleType]]
      } yield OpenapiSchemaAnyOf(d)
  }
  ...
  implicit val OpenapiSchemaNotDecoder: Decoder[OpenapiSchemaNot] = {
    (c: HCursor) =>
      for {
        d <- c.downField("not").as[OpenapiSchemaType]
      } yield OpenapiSchemaNot(d)
  }

  implicit val OpenapiSchemaObjectDecoder
      : Decoder[OpenapiSchemaObject] = { (c: HCursor) =>
    for {
      _ <- c
        .downField("type")
        .as[Option[String]]
        .ensure(DecodingFailure("Given type is not object!", c.history))(v =>
          v.forall(_ == "object")
        )
  ...
  implicit val OpenapiSchemaArrayDecoder
      : Decoder[OpenapiSchemaArray] = { (c: HCursor) =>
    for {
      _ <- c
        .downField("type")
        .as[String]
        .ensure(DecodingFailure("Given type is not array!", c.history))(v =>
          v == "array"
        )
