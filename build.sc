...
object core extends BaseModule with SbtModule {
  ...
  def ivyDeps = Agg(
    ivy"org.scalameta::scalameta::4.4.16",
    ivy"io.swagger.parser.v3:swagger-parser:2.0.25",
    ivy"com.softwaremill.sttp.model::core:1.4.6",
...
trait CommonTestModule extends BaseModule with TestModule {
  def ivyDeps = Agg(
    ...
    ivy"com.softwaremill.sttp.client3::core::3.3.0",
    ivy"com.softwaremill.sttp.client3::circe::3.3.0",
