...
object parser extends BaseModule with SbtModule {
  ...
  def ivyDeps = Agg(
    ...
    ivy"com.softwaremill.sttp.model::core:1.4.11"
  )
...
object core extends BaseModule with SbtModule {
  ...
  def ivyDeps = Agg(
    ivy"org.scalameta::scalameta::4.4.28",
...
trait CommonTestModule extends BaseModule with TestModule {
  def ivyDeps = Agg(
    ...
    ivy"com.softwaremill.sttp.client3::core::3.3.14",
    ivy"com.softwaremill.sttp.client3::circe::3.3.14",
